...
for(i in 39:n_dataset){
  ...
  write.csv(eta_intra_1,"./Main analysis/Results/Big_simulation/15/S/eta_intra_1.csv")
  write.csv(eta_intra_2,"./Main analysis/Results/Big_simulation/15/S/eta_intra_2.csv")
  
  write.csv(beta_1,"./Main analysis/Results/Big_simulation/15/S/beta_1.csv")
  write.csv(beta_2,"./Main analysis/Results/Big_simulation/15/S/beta_2.csv")
