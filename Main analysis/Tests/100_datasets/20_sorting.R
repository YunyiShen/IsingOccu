...
for(i in 23:n_dataset){
  ...
  write.csv(beta_1,"./Main analysis/Results/Big_simulation/20/S/beta_1.csv")
  write.csv(beta_2,"./Main analysis/Results/Big_simulation/20/S/beta_2.csv")

  write.csv(gamma_oc,"./Main analysis/Results/Big_simulation/20/S/gamma_oc.csv")
  write.csv(gamma_de,"./Main analysis/Results/Big_simulation/20/S/gamma_de.csv")
