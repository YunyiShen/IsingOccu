...
## generate graph 
n_grids = 10# 10 by 10 grid system
...
for(i in 67:n_dataset){
  ...
  write.csv(eta_intra_1,"./Main analysis/Results/Big_simulation/10/C/eta_intra_1.csv")
  write.csv(eta_intra_2,"./Main analysis/Results/Big_simulation/10/C/eta_intra_2.csv")
  
  write.csv(beta_1,"./Main analysis/Results/Big_simulation/10/C/beta_1.csv")
  write.csv(beta_2,"./Main analysis/Results/Big_simulation/10/C/beta_2.csv")
  
  write.csv(gamma_oc,"./Main analysis/Results/Big_simulation/10/C/gamma_oc.csv")
  write.csv(gamma_de,"./Main analysis/Results/Big_simulation/10/C/gamma_de.csv")
