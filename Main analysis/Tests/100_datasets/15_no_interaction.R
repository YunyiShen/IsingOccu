...
## generate graph 
n_grids = 15# 10 by 10 grid system
...
write.csv(eta_intra_1,"./Main analysis/Results/Big_simulation/15/N/eta_intra_1.csv")
write.csv(eta_intra_2,"./Main analysis/Results/Big_simulation/15/N/eta_intra_2.csv")

write.csv(beta_1,"./Main analysis/Results/Big_simulation/15/N/beta_1.csv")
write.csv(beta_2,"./Main analysis/Results/Big_simulation/15/N/beta_2.csv")

write.csv(gamma_oc,"./Main analysis/Results/Big_simulation/15/N/gamma_oc.csv")
write.csv(gamma_de,"./Main analysis/Results/Big_simulation/15/N/gamma_de.csv")
