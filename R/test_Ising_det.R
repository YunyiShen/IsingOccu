...
detmat_Ising = Sample_Ising_detection_rep(1,nperiod,envX,detX,beta_det = theta$beta_det,sppmat_det,Z = Z_sample,detmat,nIter=100,n=1, method = "CFTP")
Pdet_Ising_rep(1,nperiod,envX,detX,beta_det = theta$beta_det,sppmat_det,Z = Z_sample,detmat_Ising)
